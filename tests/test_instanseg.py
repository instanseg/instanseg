...
device = "cuda" if sys.platform == "linux" else "cpu" # avoid mps for now

def test_inference_brightfield():
    sys.path = sys.path[1:]
...
def test_image_readers_brightfield():
