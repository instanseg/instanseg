...
def get_augmentation_dict(
    dim_in, nuclei_channel, amount, pixel_size=0.5, augmentation_type="minimal"
):
    """
    ...
    if augmentation_type == "minimal":
                    ...
                    [
                        ...
                        (
                            ...
                            [
                                0,
                                (
                                    5 if channel_invariance else dim_in,
                                    20 if channel_invariance else dim_in,
                                ),
                            ],
                        ),  # proba,(min,max) #(1, 1)]), #
                        ("flips", [1]),
                ...
                "Brightfield": collections.OrderedDict(
                    [
                        ...
                        (
                            "normalize_HE_stains",
                            [0.1, amount * 0],
                        ),  # Probability/Amount, make sure this goes in front of normalize
                        (
                ...
                "Fluorescence": collections.OrderedDict(
                    [
                        ...
                        (
                            "add_noisy_channels",
                            [0.3, 5],
                        ),  # Probability/ max total channels
        ...
        raise ValueError(
            "Invalid augmentation type. Options are ['minimal','heavy','brightfield_only']"
        )
