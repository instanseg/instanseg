...
if __name__ == "__main__":
    ...
    os.environ["INSTANSEG_DATASET_PATH"] = str(args.data_path)
    os.environ["INSTANSEG_OUTPUT_PATH"] = str(args.output_path)
    ...
    train_images, train_labels, train_meta, val_images, val_labels, val_meta = _read_images_from_pth(data_path = args.data_path, dataset = args.dataset, data_slice = args.data_slice, dummy = args.dummy, args = args, sets= ["Train","Validation"] )
